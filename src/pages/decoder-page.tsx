...
export function DecodePage() {
  ...
  return <div className="flex flex-col md:flex-row">
    <div className="h-[100%] p-3 flex flex-col justify-center items-center gap-7 bg-gray-100 ">
      <PlainTextComponent title="Vigenere Decoder" text={text} setText={setText} />
      <div>
        <p className="text-xl font-bold text-blue-600">Plain Text: {decode(text, secretKey, alphabet)}</p>
      </div>
    </div>
